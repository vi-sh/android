...
public class TitanicTextView extends TextView {
    ...
    public interface AnimationSetupCallback {
        public void onSetupAnimation(test.example.com.verifier.TitanicTextView titanicTextView);
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (!setUp) {
            ...
            if (animationSetupCallback != null) {
                animationSetupCallback.onSetupAnimation(test.example.com.verifier.TitanicTextView.this);
            }
        }
    }
